...
class Employee1 extends Person1 {
    ...
    Employee1(int id, String qualification, String comany_name, double sal, String name, String address, int age,
            String gender) {
...
class Teacher1 extends Employee1 {
    ...
    Teacher1(String dept, String sub, int tr_id, int id, String qualification, String comany_name, double sal,
            String name, String address, int age, String gender) {
...
public class personEmpTchr {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            obj[i] = new Teacher1(t_dept, t_sub, t_id, e_id, qualification, c_name, sal, p_name, p_address, p_age,
                    p_gender);
        }
